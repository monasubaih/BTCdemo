...
(function(c, j) {
    ...
    c.ui = c.ui || {};
    if (!c.ui.version) {
        c.extend(c.ui, {version: "1.8.12", keyCode: {ALT: 18, BACKSPACE: 8, CAPS_LOCK: 20, COMMA: 188, COMMAND: 91, COMMAND_LEFT: 91, COMMAND_RIGHT: 93, CONTROL: 17, DELETE: 46, DOWN: 40, END: 35, ENTER: 13, ESCAPE: 27, HOME: 36, INSERT: 45, LEFT: 37, MENU: 93, NUMPAD_ADD: 107, NUMPAD_DECIMAL: 110, NUMPAD_DIVIDE: 111, NUMPAD_ENTER: 108, NUMPAD_MULTIPLY: 106,
...
(function(d, A) {
    ...
    d.extend(d.ui, {datepicker: {version: "1.8.12"}});
                ...
                switch (a.keyCode) {
                    ...
                    case 37:
                        ...
                        if (a.originalEvent.altKey)
                            d.datepicker._adjustDate(a.target, a.ctrlKey ?
