...
LiveValidation.prototype = {
    ...
    getElementType: function() {
        switch (true) {
            ...
            case (this.element.nodeName.toUpperCase() == 'INPUT' && (this.element.type.toUpperCase() == 'TEXT' || this.element.type.toUpperCase() == 'EMAIL' || this.element.type.toUpperCase() == 'NUMBER')):
    ...
    insertMessage: function(elementToInsert) {
        ...
        if ((this.displayMessageWhenEmpty && (this.elementType == LiveValidation.CHECKBOX || this.element.value == ''))
            ...
            //because of uniform js for this dallata it site @Hussam
            if (this.elementType == LiveValidation.SELECT) {
                this.insertAfterWhatNode.parentNode.parentNode.appendChild(elementToInsert);

            }
            else if (this.insertAfterWhatNode.nextSibling) {
                this.insertAfterWhatNode.parentNode.insertBefore(elementToInsert, this.insertAfterWhatNode.nextSibling);
            } else {
                this.insertAfterWhatNode.parentNode.appendChild(elementToInsert);
            }
        }
        //for update scroll special for this dallata it site @Hussam
    ...
    removeMessage: function() {
        ...
        if (this.elementType == LiveValidation.SELECT) {
            ...
            if (nextEl && nextEl.className.indexOf(this.messageClass) != -1) {
                this.insertAfterWhatNode.parentNode.parentNode.removeChild(nextEl);
            }
...
var Validate = {
    ...
    /**
     * @Hussam 
     *	validates that the field contains a valid URL address
     *	
     *	@var value {mixed} - value to be checked
     *	@var paramsObj {Object} - parameters for this particular validation, see below for details
     *
    ...
    URL: function(value, paramsObj) {
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "Must be a valid URL address!";
        Validate.Format(value, {failureMessage: message, pattern: /(http|ftp|https):\/\/[\w-]+(\.[\w-]+)+([\w.,@?^=%&amp;:\/~+#-]*[\w@?^=%&amp;\/~+#-])?/i});
        return true;
    },
    /**
     * @Hussam 
     *	validates that the field contains a valid mobile 
     *	
     *	@var value {mixed} - value to be checked
     *	@var paramsObj {Object} - parameters for this particular validation, see below for details
     *
     ...
     *													  (DEFAULT: "Must be a number!" or "Must be an integer!")
     */
    Moblie: function(value, paramsObj) {
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "Must be a valid Mobile!";
        Validate.Format(value, {failureMessage: message, pattern: /^((\+){0,1}91(\s){0,1}(\-){0,1}(\s){0,1})?([0-9]{10})$/i});
        return true;
    },
    /**
