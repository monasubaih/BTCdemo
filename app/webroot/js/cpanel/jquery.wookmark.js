...
$.fn.wookmark = function(options) {
    ...
    this.wookmarkLayout = function() {
        ...
        if (this.wookmarkOptions.flexibleItemWidth) {
            var overflow = containerWidth % columnWidth;
            if (overflow < columnWidth / 2) {
                columnWidth += overflow / columns;
                var adjustedItemWidth = this.wookmarkOptions.itemWidth + overflow / columns;
                this.width(adjustedItemWidth);
            }
            else {
                columns += 1;
                columnWidth = containerWidth / columns;
                var adjustedItemWidth = columnWidth - this.wookmarkOptions.offset;
                this.width(adjustedItemWidth);
            }
        }
        ...
        if (this.wookmarkOptions.resizeContainerHeight)
    ...
    this.wookmarkLayoutFull = function(columnWidth, columns, offset) {
        ...
        for (; i < length; i++) {
            ...
            heights[shortestIndex] = shortest + item.outerHeight(true) + this.wookmarkOptions.offset;
    ...
    this.wookmarkLayoutColumns = function(columnWidth, offset) {
        ...
        for (; i < length; i++) {
            ...
            for (k = 0; k < kLength; k++) {
                ...
                heights[i] += item.outerHeight(true) + this.wookmarkOptions.offset;
